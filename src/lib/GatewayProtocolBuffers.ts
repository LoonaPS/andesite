...
class GetDbGateOperationalDataRsp$Type extends MessageType<GetDbGateOperationalDataRsp> {
    ...
    create(value?: PartialMessage<GetDbGateOperationalDataRsp>): GetDbGateOperationalDataRsp {
        const message: GetDbGateOperationalDataRsp = { retcode: 0, dbConnected: false, connectedServiceCount: 0, serviceInfos: [], totalQueriesPerformed: 0, totalFailedQueries: 0, totalSuccQueries: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
